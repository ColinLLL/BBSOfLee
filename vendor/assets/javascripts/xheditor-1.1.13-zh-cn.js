...
(function ($, undefined) {
    ...
    var arrFontsize = [{ n: 'x-small', s: '10px', t: '极小' }, { n: 'small', s: '12px', t: '特小' }, { n: 'medium', s: '14px', t: '小' }, { n: 'large', s: '18px', t: '中' }, { n: 'x-large', s: '24px', t: '大' }, { n: 'xx-large', s: '32px', t: '特大' }, { n: '-webkit-xxx-large', s: '48px', t: '极大'}];
